...
export interface IVerifyingKeysRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IVerifyingKeysRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): IVerifyingKeysRegistry;
  waitForDeployment(): Promise<this>;

  interface: IVerifyingKeysRegistryInterface;
