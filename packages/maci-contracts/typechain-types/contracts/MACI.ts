...
export declare namespace MACI {
  export type InitParamsStruct = {
    pollFactory: AddressLike;
    messageProcessorFactory: AddressLike;
    tallyFactory: AddressLike;
    signUpPolicy: AddressLike;
  ...
  export type InitParamsStructOutput = [
    ...
    emptyBallotRoots: [bigint, bigint, bigint, bigint, bigint]
  ] & {
    pollFactory: string;
    messageProcessorFactory: string;
    tallyFactory: string;
