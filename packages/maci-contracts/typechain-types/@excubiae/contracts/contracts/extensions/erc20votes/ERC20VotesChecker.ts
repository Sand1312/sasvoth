...
export interface ERC20VotesCheckerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "check"
      | "getAppendedBytes"
...
export interface ERC20VotesChecker extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20VotesChecker;
  waitForDeployment(): Promise<this>;

  interface: ERC20VotesCheckerInterface;
