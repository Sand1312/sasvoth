...
import { type IVerifyingKeyContractParams, type IVerifyingKeyObjectParams, VerifyingKey } from "@maci-protocol/domainobjs";
...
/**
 * Extract the Verifying Key from a zkey
 * @param zkeyPath - The path to the zkey
 * @returns The verifying key
 */ 
const extractVerifyingKey = async (zkeyPath: string): Promise<IVerifyingKeyObjectParams> =>
  zKey.exportVerificationKey(zkeyPath) as Promise<IVerifyingKeyObjectParams>;
