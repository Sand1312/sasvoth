...
export async function PATCH(req: Request) {
  try {
    const backendUrl = new URL("/polls/addIdea", apiBase).toString();
    ...
    try {
      ...
      console.error("/api/polls/add-idea PATCH backend fetch failed:", err);
    ...
    console.error("/api/polls/add-idea PATCH error:", err);
