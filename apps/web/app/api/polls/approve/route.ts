...
export async function PATCH(req: Request) {
  try {
    const backendUrl = new URL("/polls/approveIdea", apiBase).toString();
    ...
    try {
      ...
      console.error("/api/polls/approve PATCH backend fetch failed:", err);
    ...
    console.error("/api/polls/approve PATCH error:", err);
