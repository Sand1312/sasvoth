...
export async function PATCH(req: Request) {
  try {
    const backendUrl = new URL("/ideas/updateCID", apiBase).toString();
    ...
    try {
      ...
      console.error("/api/ideas/update-cid PATCH backend fetch failed:", err);
    ...
    console.error("/api/ideas/update-cid PATCH error:", err);
